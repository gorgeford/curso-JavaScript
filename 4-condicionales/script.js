...
if(num1>0){
    ...
    if(num2>o){ 
        ...
        console.log(`$(num1) es igual a 0 y $(nume2) es menor que 0`);
    }else{ 
...
if(respuesta==true)console.log(`respuesta tirne el valor true`);

if(respuesta==false)console.log(`respuesta tirne el valor false`);
